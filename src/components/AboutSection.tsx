          ...
          <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
            ...
            <div className="relative">
              <div className="bg-gradient-to-br from-arcadia-orange/20 via-arcadia-magenta/20 to-arcadia-purple/20 rounded-2xl p-8 transform rotate-3 hover:rotate-0 transition-transform duration-300">
                <div className="bg-card dark:bg-card rounded-xl p-6 shadow-lg">
                  ...
                  <h4 className="text-xl font-poppins font-semibold text-foreground mb-2">Interface Moderna</h4>
                  <p className="text-muted-foreground font-inter">Design responsivo e experiência intuitiva</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {highlights.map((highlight, index) => (
              <div key={index} className="text-center group">
                ...
                <h4 className="text-lg font-poppins font-semibold text-foreground mb-2">{highlight.title}</h4>
                <p className="text-muted-foreground font-inter">{highlight.description}</p>
              </div>
            ))}
          </div>
        </div>
