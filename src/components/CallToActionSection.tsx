...
const CallToActionSection = () => {
  ...
  return (
    <section className="py-24 bg-gradient-to-br from-background to-muted dark:from-background dark:to-muted/50">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center">
          <div className="inline-flex items-center justify-center p-8 rounded-3xl bg-gradient-to-r from-arcadia-orange/10 via-arcadia-purple/10 to-arcadia-magenta/10 dark:from-arcadia-orange/5 dark:via-arcadia-purple/5 dark:to-arcadia-magenta/5 border border-border">
            <div className="text-center">
