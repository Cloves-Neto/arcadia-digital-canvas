...
const ContactSection = () => {
  return (
    <section className="py-20 bg-gradient-to-br from-arcadia-teal/10 via-arcadia-white to-arcadia-orange/10 relative overflow-hidden">
      {/* Decorative Elements */}
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          <div className="mb-12">
            <h2 className="text-4xl md:text-6xl font-poppins font-bold text-gray-800 mb-6">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-2xl mx-auto">
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300">
              ...
              <h3 className="text-lg font-poppins font-semibold text-gray-800 mb-2">Email</h3>
              <p className="text-gray-600 font-inter">contato@arcadia.dev</p>
            </div>
            
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300">
              <Phone className="h-8 w-8 text-arcadia-teal mx-auto mb-4" />
              <h3 className="text-lg font-poppins font-semibold text-gray-800 mb-2">Telefone</h3>
              <p className="text-gray-600 font-inter">+55 (11) 9 9999-9999</p>
            </div>
          </div>
        </div>
      </div>
